...
class DnsRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dns_record" do
    assert_difference("DnsRecord.count") do
      post dns_records_url, params: { dns_record: { domain_id: @dns_record.domain_id, host: @dns_record.host, record_type: @dns_record.record_type, ttl: @dns_record.ttl, value: @dns_record.value } }
    end
  ...
  test "should update dns_record" do
    patch dns_record_url(@dns_record), params: { dns_record: { domain_id: @dns_record.domain_id, host: @dns_record.host, record_type: @dns_record.record_type, ttl: @dns_record.ttl, value: @dns_record.value } }
